...
import com.warehouse.domain.ItemInfoAttachDTO;
...
@Controller
@Log4j
public class ItemInfoUploadController {
	...
	public ResponseEntity<List<ItemInfoAttachDTO>> uploadAjaxAction(MultipartFile[] uploadFile){
		...
		ResponseEntity<List<ItemInfoAttachDTO>> entity = null;
		
		List<ItemInfoAttachDTO> list = new ArrayList<ItemInfoAttachDTO>();
		...
		for(MultipartFile multipartFile : uploadFile) {
			...
			ItemInfoAttachDTO attachDTO = new ItemInfoAttachDTO();
		...
		entity = new ResponseEntity<List<ItemInfoAttachDTO>>(list, HttpStatus.OK);
